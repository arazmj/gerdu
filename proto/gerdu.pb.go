...
var file_proto_gerdu_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x32, 0x63,
...
var file_proto_gerdu_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_proto_gerdu_proto_depIdxs = []int32{
	...
	0, // 2: gerdu.Gerdu.Put:output_type -> gerdu.PutResponse
	3, // 3: gerdu.Gerdu.Get:output_type -> gerdu.GetResponse
